...
from fake_ecodes import keys, KEY, SYN, REL, ABS, FF, EV_KEY, EV_REL, EV_ABS, EV_SYN, EV_FF
...
class FFEvent(object):
    ...
    def __str__(self):
        ...
        return msg.format(self.event.timestamp(), FF.get(self.event.code, "UNKNOWN"))
